...
// src/http/controllers/question/create.spec.ts
...
(0, import_vitest.describe)("Create question (E2E)", () => {
  (0, import_vitest.it)("Should be create a question", async () => {
  ...
  (0, import_vitest.it)("User cannot create a question with a title already used", async () => {
    const { token } = await createAndAuthenticateTest(app, {
  ...
  (0, import_vitest.it)("Error on create a question without title or content", async () => {
    const { token } = await createAndAuthenticateTest(app, {
