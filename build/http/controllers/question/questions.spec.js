...
// src/http/controllers/question/questions.spec.ts
...
(0, import_vitest.describe)("Question list (E2E)", () => {
  (0, import_vitest.it)("Should be show a list of questions", async () => {
    ...
    const response = await (0, import_supertest2.default)(app.server).get("/question").set("Authorization", `Bearer ${token}`).send();
    (0, import_vitest.expect)(response.body).toHaveLength(2);
