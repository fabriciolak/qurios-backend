...
// src/use-cases/question/delete.spec.ts
...
var usersRepository;
var userCreate;
(0, import_vitest.describe)("Delete question use case", () => {
  ...
  (0, import_vitest.it)("Should be delete a question", async () => {
    ...
    (0, import_vitest.expect)(response).toEqual({});
  });
});
